<?php
    ...
    $hid=$_GET['del'];
    $hsql = "DELETE from  hod  WHERE id=:id";
    $hquery = $dbh->prepare($hsql);
    $hquery -> bindParam(':id',$id, PDO::PARAM_STR);
    $hquery -> execute();
    $hmsg="The selected HOD account has been deleted";
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 else if($hmsg){?><div class="alert alert-success alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($hmsg); ?> 
                                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                 </div><?php }?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-hod.php" class="btn btn-sm btn-info">Add New HOD</a></center>
                                    <table id="dataTable3" class="table table-striped table-hover text-center">
                                        ...
                                        <tbody>
                                    <?php $hsql = "SELECT * from hod";
                                    $hquery = $dbh -> prepare($hsql);
                                    $hquery->execute();
                                    $results=$hquery->fetchAll(PDO::FETCH_OBJ);
                                    $cont=1;
